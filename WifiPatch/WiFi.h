...
public:
    ...
    /* Starts wifi without any params.
     * Allows usage of localy stored profiles
     * those profiles shall be created using Ti's Smartconfig
     * Start Wifi connection for Ti's Smart Configured network
     */
    int begin();

    /* Clears all profiles (Stored Smart Configured networks)*/
    int clearProfiles();
